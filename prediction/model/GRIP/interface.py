...
class GRIPInterface(Interface):
    def __init__(self, obs_length=15, pred_length=25, pre_load_model=None, max_hop=2, num_node=260, in_channels=4, rescale=[669.691/2, 669.691/2], smooth=0, dataset=None):
