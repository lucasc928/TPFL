...
class NGSIMDataset(ApolloscapeDataset):
    def __init__(self, obs_length, pred_length, time_step, sample_step=5):
        ...
        self.test_data_path = os.path.join(self.data_dir, "prediction_test.new")
        self.val_data_path = os.path.join(self.data_dir, "prediction_val.new")
        self.train_data_path = os.path.join(self.data_dir, "prediction_train.new")
        self.data_path = {
